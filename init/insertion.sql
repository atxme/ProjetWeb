...
-- Insertion Présidents avec prime
INSERT INTO President VALUES 
(2, '2023-01-01', 1000.00),
(3, '2023-01-01', 1200.00);

-- Insertion des Concours (uniquement ceux pertinents par rapport à la date actuelle)
INSERT INTO Concours VALUES
(1, 2, 'Automne 2024', '2024-09-21', '2024-12-20', 'evalue', 6, 36, 'Concours Automne 2024', 'automne', 2024),
(2, 3, 'Hiver 2024', '2024-12-21', '2025-01-15', 'en cours', 6, 36, 'Concours Hiver 2024', 'hiver', 2024);
...
(1, 1), (1, 2), (1, 3), -- Minimum 6 clubs par concours
(2, 1), (2, 2), (2, 3);
